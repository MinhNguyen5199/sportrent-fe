...
const Staffs = () => {
  ...
  const cancel = (e) => {
          navigate("/ManagerLayout/StaffList");
  };
...
console.log(user)
  ...
  const title = () => {
    if (id) {
      return (<h5 className="text-CamelCase text-left mb-1">Update Staff Account</h5>);
    } else {
      return (<h5 className="text-CamelCase text-left mb-1">  Create a New Staff Account</h5> );
    }
  };
